        ...
        <form onSubmit={handleSubmit} className='space-y-6'>
            <div className='flex justify-between'>
                {code.map((digit, index) => (
                    ...
                    className='w-12 h-12 text-center text-2xl font-bold bg-gray-800 text-white border-2 border-gray-500 rounded-lg focus:outline-none focus:ring focus:ring-green-500'
                    />
                ))}
            </div>
